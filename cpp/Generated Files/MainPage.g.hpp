...
/// </summary>
class SDKTemplate::MainPage::MainPage_obj15_Bindings 
        ...
        switch (phase)
        {
            case 0:
                *nextPhase = -1;
                ...
                {
                    this->obj15.Resolve<::Windows::UI::Xaml::Controls::TextBlock>()->DataContextChanged -= this->_dataContextChangedToken;
    ...
    void Update_Title(::Platform::String^ obj, int phase)
    {
        if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
        {
            ...
            if (!isobj15TextDisabled)
            {
                ...
                {
                    Set_Windows_UI_Xaml_Controls_TextBlock_Text(this->obj15.Resolve<::Windows::UI::Xaml::Controls::TextBlock>(), obj, nullptr);
                }
            }
        }
    }
...
bool SDKTemplate::MainPage::MainPage_obj15_Bindings::isobj15TextDisabled = false;
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::SDKTemplate::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
    ...
    switch (__connectionId)
    {
        case 15: // MainPage.xaml line 37
            {
                ::Windows::UI::Xaml::Controls::TextBlock^ element15 = safe_cast<::Windows::UI::Xaml::Controls::TextBlock^>(__target);
                ...
                ::Windows::UI::Xaml::Markup::XamlBindingHelper::SetDataTemplateComponent(element15, bindings);
            }
            break;
    }
    return bindings;
